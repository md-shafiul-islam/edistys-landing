    ...
    <div className="w-full top-0 left-0 grid grid-cols-1 gap-7 z-50">
      <div className="w-full flex items-center justify-between py-3">
        <div className="md:w-full flex flex-row gap-6 items-center justify-between">
          ...
          <Link
            className="flex flex-row gap-5 items-center border font-bold hover:text-b-blue hover:bg-white  [text-shadow:2px_2px_3px_rgba(0,0,0,.4)] border-white px-5 py-2 rounded-sm"
            href="#"
          >
