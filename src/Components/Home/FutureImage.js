...
import AnimatedSVGIcon from "@/Components/Utils/AnimatedSVGIcon";
const FutureImage = () => {
  return (
    <div className="relative p-4 flex flex-col items-center">
        ...
        <AnimatedSVGIcon>
          ...
          >
            <path
              ...
              fill="url(#paint0_linear_5178_22465)"
            />
            <defs>
              <linearGradient
                id="paint0_linear_5178_22465"
                x1="0.000149879"
                y1="408"
                x2="362.5"
                y2="20.5"
      ...
      <div className="absolute w-8/12 shadow-xl">
        <CstImage to="/assets/images/feature.avif" className="w-full " />
      </div>
      {/* Bank Start */}
